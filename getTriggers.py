...
"""
Search triggers by name, print the id and name (or extended info with -e)
...
def main(argv):
    ...
    if (args.e):
        ...
        for trigger in triggers:
            print(
                "ID: {} - Status: {} - Trigger: {}".format(trigger['triggerid'], trigger['status'], trigger['description']))
